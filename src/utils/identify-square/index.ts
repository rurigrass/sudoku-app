...
/**
 * A function that identifies and returns the current square of a given sudoku grid at a row and a column index
 * @param input Object with 9X9 sudoku Grid, Rowindex and Col index
 * @returns
 */
